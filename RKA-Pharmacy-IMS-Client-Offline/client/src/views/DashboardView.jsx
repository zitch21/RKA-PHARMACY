    ...
    <div className="space-y-6 pb-12">
      ...
      {uiMode === 'minimalist' ? (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <div className="text-xs font-bold text-amber-800 flex items-center gap-1.5">
                {(summary.low_stock_count || 0) > 0 ? (
                  <span>Click to view suggested purchase orders →</span>
                ) : (
          ...
          {/* Two Giant Emergency & Counter Action Panels */}
          ...
          <div className="p-4 bg-slate-50 rounded-xl border border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-xs text-slate-500">
            <span>
              Operating in <strong>Clean / Minimalist Mode</strong> (simplified for counter dispensing).
            </span>
            <button
            ...
            <table className="w-full text-left text-xs border-collapse">
              <thead>
                <tr className="border-b border-indigo-800 text-indigo-200 text-[11px] uppercase tracking-wider">
                  ...
                  <th className="py-2.5 px-3">Daily Sales (ADQS)</th>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-5 shadow-xs flex flex-col justify-between">
          ...
          <div className="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500">
            <span>Formula: ADQS × (Lead Time + Buffer)</span>
